...
export const PROJECTS: Project[] = [
	{
		name: "Troc 35",
		slug: "troc-35",
		type: "Refonte complète — Dépôt-vente",
		accentColor: "#00b1c9",
		logoText: "TR",
		image: "/projects/troc-35.png",
		screenshots: [
			"/projects/troc-35.png",
			"/projects/troc-35-boutique.png",
			"/projects/troc-35-horaires.png",
			"/projects/troc-35-contact.png",
			"/projects/troc-35-estimation.png",
			"/projects/troc-35-compte.png",
		],
		client: "Troc 35",
		...
		year: "2025",
		context:
			"Troc 35 est un dépôt-vente de 1 300 m² installé à La Richardais depuis 2009, entre St-Malo et Dinard. Référence locale pour les meubles, l'électroménager et les objets d'occasion, le magasin avait un site PrestaShop vieillissant qui ne reflétait plus la qualité de leur offre.",
		problem:
			"L'ancien site était lent, non responsive et mal référencé. Les clients ne trouvaient ni les horaires, ni les catégories de produits. L'absence de catalogue en ligne limitait la visibilité des arrivages. Le magasin n'apparaissait qu'en page 3 de Google pour les recherches locales.",
		solution:
			"Refonte complète sur Next.js avec intégration de l'API PrestaShop pour afficher les arrivages en temps réel. Design moderne avec boutique en ligne filtrable par catégorie, statut du magasin en temps réel (ouvert/fermé), formulaire d'estimation gratuite à domicile, Google Maps intégré et optimisation SEO locale avec données structurées JSON-LD.",
		results: [
			"Temps de chargement passé de 8s à 1.2s",
			"Score Lighthouse 98/100",
			"+180% de trafic organique en 3 mois",
			"Arrivages visibles en ligne dès leur ajout en magasin",
		],
		techStack: [
			"Next.js",
			"React",
