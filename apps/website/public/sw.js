;(() => {
	...
	async function m(e, t, a, s) {
		...
		for (const i of await e.keys(t, n)) if (r === d(i.url, a)) return e.match(i, s)
	}
	class f {
		promise
		resolve
	...
	class K {
		_db = null
		async addEntry(e) {
			const t = (await this.getDb()).transaction(O, "readwrite", { durability: "relaxed" })
	...
	class $ {
		...
		static async fromRequest(e) {
			...
			for (const a of ("GET" !== e.method && (t.body = await e.clone().arrayBuffer()),
	...
	const H = "serwist-background-sync",
		G = new Set(),
		Q = (e) => {
			const t = { request: new $(e.requestData).toRequest(), timestamp: e.timestamp }
	...
	class V {
		...
		async _addRequest({ request: e, metadata: t, timestamp: a = Date.now() }, s) {
			const r = { requestData: (await $.fromRequest(e.clone())).toObject(), timestamp: a }
	...
	class ee extends Z {
		...
		async _handle(e, t) {
			...
			if (this._networkTimeoutSeconds) {
				const { id: n, promise: i } = this._getTimeoutPromise({ request: e, logs: s, handler: t })
				;(a = n), r.push(i)
			}
			const n = this._getNetworkPromise({ timeoutId: a, request: e, logs: s, handler: t })
			r.push(n)
			const i = await t.waitUntil((async () => (await t.waitUntil(Promise.race(r))) || (await n))())
			...
			this._upgradeDb(e),
				this._cacheName &&
					((e, { blocked: t } = {}) => {
						...
						t && a.addEventListener("blocked", (e) => t(e.oldVersion, e)), v(a).then(() => void 0)
					})(this._cacheName)
		}
		async setTimestamp(e, t) {
			e = eu(e)
			const a = { id: this._getId(e), cacheName: this._cacheName, url: e, timestamp: t },
	...
	class eq {
		...
		cacheKeyWillBeUsed = async ({ request: e, params: t }) => {
			const a = t?.cacheKey || this._precacheController.getPrecacheKeyForUrl(e.url)
...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`)
	...
	new eS({
		precacheEntries: [
			{
				revision: "5d0948b751dd13d8f0f896491ad4c196",
				url: "/_next/static/_FLgrVSsUcj4dhGpXx9qd/_buildManifest.js",
			},
			{
				revision: "b6652df95db52feb4daf4eca35380933",
				url: "/_next/static/_FLgrVSsUcj4dhGpXx9qd/_ssgManifest.js",
			},
			{ revision: null, url: "/_next/static/chunks/317-709e6d31ab1e948b.js" },
			{ revision: null, url: "/_next/static/chunks/512-fc7755b87ef48e0b.js" },
			{ revision: null, url: "/_next/static/chunks/574-a66c88fada9ab9d4.js" },
			{ revision: null, url: "/_next/static/chunks/69-5790b37aaef7595d.js" },
			{ revision: null, url: "/_next/static/chunks/733-585c4c318aaa2529.js" },
			{ revision: null, url: "/_next/static/chunks/760-ef56c3419482f49a.js" },
			{ revision: null, url: "/_next/static/chunks/859-a389cbb78dcc3e22.js" },
			{ revision: null, url: "/_next/static/chunks/87-06a7025017dc206b.js" },
			{ revision: null, url: "/_next/static/chunks/991-2365a8f87fdcff32.js" },
			{ revision: null, url: "/_next/static/chunks/afde9cf2-e2d3ed9ac30033fe.js" },
			{
				revision: null,
				url: "/_next/static/chunks/app/%5Blocale%5D/a-propos/page-9913d86848b8ee53.js",
			},
			{
				revision: null,
				url: "/_next/static/chunks/app/%5Blocale%5D/avis/page-bbc5741fd3be8dbd.js",
			},
			{
				revision: null,
				url: "/_next/static/chunks/app/%5Blocale%5D/blog/%5Bslug%5D/page-044f5f57afc5a62c.js",
			},
			{
				revision: null,
				url: "/_next/static/chunks/app/%5Blocale%5D/blog/page-23014c6f9154c7bc.js",
			},
			{ revision: null, url: "/_next/static/chunks/app/%5Blocale%5D/cgv/page-4abebd019d8d5a1d.js" },
			{ revision: null, url: "/_next/static/chunks/app/%5Blocale%5D/layout-3aa4ea3b7372d408.js" },
			{
				revision: null,
				url: "/_next/static/chunks/app/%5Blocale%5D/mentions-legales/page-4abebd019d8d5a1d.js",
			},
			{
				revision: null,
				url: "/_next/static/chunks/app/%5Blocale%5D/not-found-d6b1deaac6e2a190.js",
			},
			{ revision: null, url: "/_next/static/chunks/app/%5Blocale%5D/page-c7e454d5bd65af83.js" },
			{
				revision: null,
				url: "/_next/static/chunks/app/%5Blocale%5D/realisations/%5Bslug%5D/page-ec5c455744a3895b.js",
			},
			{
				revision: null,
				url: "/_next/static/chunks/app/%5Blocale%5D/realisations/page-bead66b2f43d026b.js",
			},
			{ revision: null, url: "/_next/static/chunks/app/%5Blocale%5D/template-82df261f90e869bd.js" },
			{ revision: null, url: "/_next/static/chunks/app/_global-error/page-cb7ba8e5fcc9e87a.js" },
			{ revision: null, url: "/_next/static/chunks/app/_not-found/page-08fde689c932a7a4.js" },
			{ revision: null, url: "/_next/static/chunks/app/api/contact/route-cb7ba8e5fcc9e87a.js" },
			{ revision: null, url: "/_next/static/chunks/app/icon/route-cb7ba8e5fcc9e87a.js" },
			{ revision: null, url: "/_next/static/chunks/app/layout-4a272c406124daa5.js" },
			{ revision: null, url: "/_next/static/chunks/app/opengraph-image/route-cb7ba8e5fcc9e87a.js" },
			{ revision: null, url: "/_next/static/chunks/app/robots.txt/route-cb7ba8e5fcc9e87a.js" },
			{ revision: null, url: "/_next/static/chunks/app/sitemap.xml/route-cb7ba8e5fcc9e87a.js" },
			{ revision: null, url: "/_next/static/chunks/framework-c1a985c867714b4b.js" },
			{ revision: null, url: "/_next/static/chunks/main-56ab33fe150eb13c.js" },
			{ revision: null, url: "/_next/static/chunks/main-app-6df640a867706e1a.js" },
			{
				revision: null,
				url: "/_next/static/chunks/next/dist/client/components/builtin/app-error-cb7ba8e5fcc9e87a.js",
			},
			{
				revision: null,
				url: "/_next/static/chunks/next/dist/client/components/builtin/forbidden-cb7ba8e5fcc9e87a.js",
			},
			{
				revision: null,
				url: "/_next/static/chunks/next/dist/client/components/builtin/global-error-75e9bb1cc7ea6082.js",
			},
			{
				revision: null,
				url: "/_next/static/chunks/next/dist/client/components/builtin/not-found-cb7ba8e5fcc9e87a.js",
			},
			{
				revision: null,
				url: "/_next/static/chunks/next/dist/client/components/builtin/unauthorized-cb7ba8e5fcc9e87a.js",
			},
			{
				revision: "846118c33b2c0e922d7b3a7676f81f6f",
				url: "/_next/static/chunks/polyfills-42372ed130431b0a.js",
			},
			{ revision: null, url: "/_next/static/chunks/webpack-b4bfad7d3f6b2c23.js" },
			{ revision: null, url: "/_next/static/css/68756b5657f28c77.css" },
			{
			...
			{ revision: "ac061f47c18046fe3aeb8cf061dd4fe9", url: "/icons/icon-192.svg" },
			{ revision: "792b1809d6dc5b2d43cbac0aaa401c4c", url: "/icons/icon-512.svg" },
			{ revision: "f2b43218efcea62ef2f36bbc362aaee8", url: "/manifest.json" },
			{ revision: "778fca6b53bd157d9f9b9580ff3f9086", url: "/projects/troc-35-boutique.png" },
			{ revision: "4022dc652efe74c4a55dafde4125529f", url: "/projects/troc-35-compte.png" },
			{ revision: "29b300d24719289aa4ac1ccfe47e24e9", url: "/projects/troc-35-contact.png" },
			{ revision: "b51999a85f5634ce3934f9406d1e6e3a", url: "/projects/troc-35-estimation.png" },
			{ revision: "cf43c58f86b665403ec14e8534e508d7", url: "/projects/troc-35-horaires.png" },
			{ revision: "cecfcef3b45f82e35a5454690fb98819", url: "/projects/troc-35.png" },
		],
		skipWaiting: !0,
		clientsClaim: !0,
		navigationPreload: !0,
