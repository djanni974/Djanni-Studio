...
export default async function DemandeProjetPage({
	...
	const [messages, bc, contactFaqT] = await Promise.all([
		getMessages(),
		getTranslations({ locale, namespace: "breadcrumb" }),
		getTranslations({ locale, namespace: "contactFaq" }),
	])

	const faqItems = contactFaqT.raw("items") as { question: string; answer: string }[]
	const faqJsonLd = {
