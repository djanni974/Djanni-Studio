			...
			<motion.div variants={noAnim ? noMotion : itemVariants} className="mt-9">
				<Link
					...
					className={cn(
						...
						featured
							? "bg-white text-djanni-orange hover:bg-djanni-cream hover:shadow-[0_4px_20px_rgba(255,255,255,0.3)]"
							: "border border-border text-foreground hover:border-djanni-orange/40 hover:bg-foreground/4 hover:shadow-[0_4px_20px_rgba(232,80,10,0.08)]",
					)}
				>
					{ctaLabel}
				</Link>
